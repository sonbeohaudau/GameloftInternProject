...
class GL2JNIView extends GLSurfaceView {
	...
	private static class Renderer implements GLSurfaceView.Renderer {
		// private static String TAG_RENDER = "Renderer";
		public int height;
		public int width;
		...
		public void onSurfaceChanged(GL10 gl, int width, int height) {
			Log.i("CUONG.NV", "onSurfaceChanged to call INIT width=" +width + "height="+height );
			this.height = height;
			this.width = width;
		...
		public void onSurfaceCreated(GL10 gl, EGLConfig config) {
			Log.i("CUONG.NV", "onSurfaceCreated(GL10 gl, EGLConfig config)");
		}
	}
}
